...
@section('superadmin')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">All Base Staff Users</h4>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Base Staff List</h4>
    ...
    <div class="modal fade" id="deletebasestaff" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Delete Base Staff Account</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{route('super.admin.delete.basestaff')}}" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            are you sure to delete this base staff account ?
                            <input type="hidden" class="basestaffdelaccount" name="delete_base_staff_account">
                        </div>
                    </div>
...
@section('js')
    ...
    <script>
        ...
        function deletebasestaf(id) {
            $('.basestaffdelaccount').val(id);
        }
        ...
        $(document).ready(function () {
            $('#adminusers').DataTable({
                ...
                "ajax": {
                    "type": "GET",
                    "url": "{{route('super.admin.get.all.basestaff')}}"
                },
                columns: [
