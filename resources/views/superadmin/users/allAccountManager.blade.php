...
@section('superadmin')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">All Account Manager Users</h4>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Account Manager List</h4>
    ...
    <div class="modal fade" id="deleteaccmanager" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Delete Account Manager Account</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{route('super.admin.delete.accountmanager')}}" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            are you sure to delete this account manager account ?
                            <input type="hidden" class="accmandelaccount" name="delete_accou_manager_account">
                        </div>
                    </div>
...
@section('js')
    ...
    <script>
        ...
        function deleaccman(id) {
            $('.accmandelaccount').val(id);
        }
        ...
        $(document).ready(function () {
            $('#adminusers').DataTable({
                ...
                "ajax": {
                    "type": "GET",
                    "url": "{{route('super.admin.get.all.accountmanager')}}"
                },
                columns: [
