...
@section('superadmin')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Update Mis Account</h4>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <form class="needs-validation" novalidate="" action="{{route('super.admin.mis.update')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="account_type">
                                        <option value="4" {{$user->account_type == 4 ? 'selected' : ''}}>Mis</option>
                                    </select>
                                </div>
                            </div>
                        </div>
