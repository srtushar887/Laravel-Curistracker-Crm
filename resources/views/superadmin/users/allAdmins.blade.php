...
@section('superadmin')
    ...
    <div class="modal fade" id="admindelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('super.admin.delete.admin')}}" method="post">
                    @csrf
                <div class="modal-body">
                    <div class="form-group">
                        are you sure to delete this admin account ?
                        <input type="hidden" class="admindelaccount" name="delete_admin_account">
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#adminusers').DataTable({
                ...
                "ajax": {
                    "type": "GET",
                    "url": "{{route('super.admin.get.all.admin')}}"
                },
                columns: [
